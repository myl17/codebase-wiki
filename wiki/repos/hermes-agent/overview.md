...
```mermaid
graph LR
    hermes_agent_self_learning_loop_decision["self-learning-loop-decision<br/>DesignDecision"] -->|motivates| hermes_agent_ai_agent["ai-agent<br/>Component"]
    hermes_agent_layered_approval_decision["layered-approval-decision<br/>DesignDecision"] -->|motivates| hermes_agent_approval_system["approval-system<br/>Component"]
    hermes_agent_context_engine["context-engine<br/>ExtensionPoint"] -->|embodies| concept_Context_压缩["concept:Context 压缩"]
    hermes_agent_context_engine["context-engine<br/>ExtensionPoint"] -->|targets| hermes_agent_ai_agent["ai-agent<br/>Component"]
    hermes_agent_event_hooks["event-hooks<br/>ExtensionPoint"] -->|embodies| concept_插件系统["concept:插件系统"]
    hermes_agent_event_hooks["event-hooks<br/>ExtensionPoint"] -->|targets| hermes_agent_ai_agent["ai-agent<br/>Component"]
    hermes_agent_ast_autodiscovery_decision["ast-autodiscovery-decision<br/>DesignDecision"] -->|motivates| hermes_agent_event_hooks["event-hooks<br/>ExtensionPoint"]
    hermes_agent_memory_provider["memory-provider<br/>ExtensionPoint"] -->|targets| hermes_agent_ai_agent["ai-agent<br/>Component"]
    hermes_agent_platform_adapter["platform-adapter<br/>ExtensionPoint"] -->|embodies| concept_插件系统["concept:插件系统"]
    hermes_agent_platform_adapter["platform-adapter<br/>ExtensionPoint"] -->|targets| hermes_agent_ai_agent["ai-agent<br/>Component"]
    hermes_agent_layered_approval_decision["layered-approval-decision<br/>DesignDecision"] -->|motivates| hermes_agent_skills_guard["skills-guard<br/>Component"]
    hermes_agent_tool_registry["tool-registry<br/>Component"] -->|embodies| concept_插件系统["concept:插件系统"]
    hermes_agent_ast_autodiscovery_decision["ast-autodiscovery-decision<br/>DesignDecision"] -->|motivates| hermes_agent_tool_registry["tool-registry<br/>Component"]
    hermes_agent_toolset_system["toolset-system<br/>ExtensionPoint"] -->|targets| hermes_agent_tool_registry["tool-registry<br/>Component"]
```
<!-- /generated-mermaid -->
