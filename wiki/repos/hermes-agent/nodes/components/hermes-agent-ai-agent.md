...
**设计原因**（motivates）：
- [[hermes-agent/nodes/design-decisions/hermes-agent-self-learning-loop-decision]] — 该决策催生了此节点
...
- [[hermes-agent/nodes/extension-points/hermes-agent-platform-adapter]]
<!-- /generated -->
